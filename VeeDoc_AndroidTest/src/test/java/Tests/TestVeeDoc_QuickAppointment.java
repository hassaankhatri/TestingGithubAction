...
public class TestVeeDoc_QuickAppointment extends BaseClass{
	...
	String password;
	String verifyName;
	String nameWithRadomDigitNumber;
	int dayofMonth;
	...
	@Test(dataProvider = "appointdata")
	public void Veedoc_QuickAppointment(String fname, String lname, String eemail, String number, String reason) 
			throws Exception {
		
		nameWithRadomDigitNumber = fname + utility.randomIdentifier();
		verifyName = nameWithRadomDigitNumber + " " + lname;
		...
		addappoint.createQuickAppointment(nameWithRadomDigitNumber, lname, eemail, number, reason);
		...
		System.out.println(appoint.verifyPname(verifyName) + "  geting this");
		System.out.println(verifyName + "  verifing this");
		...
		//functions for Signout
		 ...
		 test.log(Status.INFO, "VeeDoc Add Quick Appointment Test Completed");
